...
export function ConfigureReferralCommissionModal({
  ...
  const rates = useMemo(
    () =>
      getReferralCommissionRateBounds(
        form.tempNumberCommissionPercent,
        form.mailCommissionPercent,
        form.accountCommissionPercent,
        form.proxyCommissionPercent,
      ),
    [form],
  );

  const isCommissionRateValid = (value) => {
  ...
  const isValid =
    isCommissionRateValid(form.tempNumberCommissionPercent) &&
    isCommissionRateValid(form.mailCommissionPercent) &&
    isCommissionRateValid(form.accountCommissionPercent) &&
    isCommissionRateValid(form.proxyCommissionPercent) &&
